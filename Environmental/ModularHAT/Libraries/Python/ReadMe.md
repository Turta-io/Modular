# Python Libraries
This directory includes Python libraries for Environmental Module.

## Index
* __Turta_Environmental_Module.py:__ Python Library for Bosch Sensortec BME680 Environmental Sensor.
